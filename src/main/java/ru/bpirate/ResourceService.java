...
public class ResourceService {
    public static void exportResource(String resourceName, String folderPath) throws BackendException {
        ...
        InputStream stream = ResourceService.class.getResourceAsStream(resourceName);//note that each / is a directory down in the "jar tree" with jar being the root of the tree
